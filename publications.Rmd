...
for (i in names(html2)) {
  temp <- apply(html2[[i]], 1, function(x)
    ...
    paste(# add the altimetric and dimension badges to the publication reference
      paste0(
        ...
        paste(
          ...
          # the block to make the correspondence between publication title and the link to download the pdf (either a pdf stored in github repository or a web link to the pdf when the article is OA)
          icon_link(
            icon = "fa fa-file-pdf",
            text = " PDF",
            url =  ifelse(
