...
During my stay at the <a href='https://www6.paca.inrae.fr/institut-sophia-agrobiotech'>Institut Sophia Agrobiotech—ISA</a>, I was involved in the <a href='https://ecophytopic.fr/recherche-innovation/proteger/projet-bidime'>BIDIME project</a>. Briefly, this project aimed to develop innovation in biological pest control solutions and transfer it to farmers and land managers.<br/><br/>
More particularly, I joined <a href='https://vcalcagnoresearch.wordpress.com/'>Vincent CALCAGNO</a>'s lab to investigate the variability of movements of insect groups to temperature among 35 populations sampled along a latitude gradient.<br/><br/>
Here I mainly collaborated with <a href='https://fr.linkedin.com/in/michela-ion-scotta'>Michela ION SCOTTA</a> who reared the populations of small parasitoid fly named <em>Trichogramma</em>. Michela has also video-recorded the insect groups during steady decreases/increases in temperature (2 hours, see fig. \@ref(fig:Ramps)).</p>
...
```
<p class="detailed-text">
Once the videos were recorded, I used video-tracking solutions to retrieve flies' movements over the temperature ramps.<br/>
...
Besides this work also inspired the development of an `r fontawesome::fa("r-project", fill = "steelblue")` package (MoveR) to easily filter, clean and analyze movement data. <br/><br/>
...
```
This study paved the way to further projects/studies investigating the spatial occurrence, transfers, fate and effects of metallic palaeo-pollution in eastern France (e.g., <a href='https://chrono-environnement.univ-fcomte.fr/spip.php?page=projet&projet=23'>SIDEROS</a> and <a href='https://chrono-environnement.univ-fcomte.fr/spip.php?page=projet&projet=53'>ALTERICS</a>).<br/><br/>
...
<table style="border: none; width='100%';">
  <tr>
    <td style="width: 80%; vertical-align: top;">
<p class="detailed-text">
During my first year of master I conducted an internship with <a href='https://chrono-environnement.univ-fcomte.fr/spip.php?page=perso&nom=GIMBERT&prenom=Fr%C3%A9d%C3%A9ric'> Fr&eacute;d&eacute;ric GIMBERT</a> and <a href='https://chrono-environnement.univ-fcomte.fr/spip.php?page=perso&nom=ALEYA&prenom=Lotfi'>Lotfi ALEYA</a>  to work on the bioavailability of trace metal elements in a landfill leachate collection pond. Indeed, until 2002 household waste disposal was authorized in France, resulting in contamination of the surrounding environment, primarily through contaminants leaching. To reduce environmental contamination entailed by this mode of waste storage, the Etueffont landfill (i.e., study site) set up a lagoon ponds system draining landfill leachates.<br/><br/>
Here, we aimed to better understand how the leaching of trace metal elements may affect contaminant accumulation in biota (i.e., bioaccumulation kinetics) and how water and sediment compartments may contribute to the observed bioaccumulation' patterns.<br/><br/>
