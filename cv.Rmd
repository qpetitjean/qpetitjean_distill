...
Following my previous postdoctoral experience performing lab. (DNA extractions – PCR) and bioinformatics analyses, my growing interest in the intraspecific variability of responses to global changes guided me to join the <a href='https://www6.paca.inrae.fr/institut-sophia-agrobiotech'>Institut Sophia Agrobiotech—ISA</a>. Here I was involved in the <a href='https://ecophytopic.fr/recherche-innovation/proteger/projet-bidime'>BIDIME project</a> aiming to develop innovation in biological pest control solutions and transfer it to farmers and land managers.<br/><br/>
More particularly, I joined <a href='https://vcalcagnoresearch.wordpress.com/'>Vincent CALCAGNO</a>'s lab to investigate the movement variability among insect populations facing temperature changes. Here I mainly collaborated with <a href='https://fr.linkedin.com/in/michela-ion-scotta'>Michela ION SCOTTA</a>, who reared the 35 populations of small parasitic micro-wasps (i.e., <em>Trichogramma</em>) that have been sampled along a latitude gradient. Michela has also video-recorded the insect groups during steady decreases/increases in temperature (2 hours, see fig. \@ref(fig:Ramps)).</p>
