...
description: "CV of Quentin Petitjean (INRAE)"
output: 
...
cat('<link rel="canonical" href="https://qpetitjean.github.io/qpetitjean_distill/cv.html">')
``` 
...
<br/>
<p style='font-family: var(--font-header); font-weight: 700; color: var(--header-color); font-style: bold; font-size:175%;'>Quentin PETITJEAN, Ph.D&nbsp;<a href="mailto:quentin.petitjean@inrae.fr"><i class="fa fa-envelope fa-1.5x" aria-hidden="true"></i></a></p>
<div style="height: 0.125rem;"><br></div>
<p class="plain-text">
`r fontawesome::fa("flag", fill = "#333333")` &ensp; Nationalities<br/>
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Flag_of_France.svg/langfr-1280px-Flag_of_France.svg.png" height="30px" width="45px" /> &ensp; <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Flag_of_Switzerland_%28Pantone%29.svg/langfr-800px-Flag_of_Switzerland_%28Pantone%29.svg.png" height="30px" width="30px" /></p> 

<p class="plain-text">
`r fontawesome::fa("location-dot", fill = "#333333")` &ensp; Present/last institutional address<br/>
<a href="https://maps.app.goo.gl/wi1YkxL1J7GKTNZr8"> <small>Bees & Environment Unit (AE, INRAE), Avignon, France.</small></a></p> 
...
# RESEARCH EXPERIENCE
<p class="plain-text">
`r fontawesome::fa("briefcase", fill = "#333333")` &ensp; January 2025 - Present | Research Scientist | <a href='https://abeilles-et-environnement.paca.hub.inrae.fr/'>National Research Institute for Agriculture, Food and Environment—INRAE; Bees & Environment Unit—AE</a>, Avignon, FR </p>
<p class="detailed-text">
<em><u>Title:</u> «Wild bees ecotoxicology».<br/></p>
<details>
...
<p class="detailed-text"> 
I have started a permanent researcher position at the <a href='https://abeilles-et-environnement.paca.hub.inrae.fr/'>Bees & Environment unit (AE)</a> on January 2025.<br/><br/>
More particularly, I will investigate how contaminants and stressors may affects bees health.<br/><br/>
More details to come soon ! 
</p>
</td>
    <td style="width: 20%; vertical-align: top;">
    
```{r AELogoSet, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("inrae", "umtPrade")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
width <- logoData$widthpx[logoData$Logo == i]

Res[i] <- cat(sprintf('<a title="%s" href="%s">
<img src="%s" width="%spx" style="display: block; margin: auto;" />
</a></br>', Website, Website, Logo, width))
}
cat(Res)
```
...
<p class="plain-text">
`r fontawesome::fa("briefcase", fill = "#333333")` &ensp; February 2024 - December 2024 | Postdoctoral researcher | <a href='https://eng-eabx.bordeaux-aquitaine.hub.inrae.fr/'>National Research Institute for Agriculture, Food and Environment—INRAE; Aquatic ecosystems and global change Unit—EABX</a>, Cestas, FR </p>
<p class="detailed-text">
<em><u>Title:</u> «Modeling the effects of anthropogenic pressures on migratory fishes».<br/>
<u>Supervisor(s):</u> Dr. Bertrand VILLENEUVE.</em><br/></p>
<details>
  <summary class= "summary">
  Read the story behind (click to unroll)
  </summary>
<table style="border: none; width='100%';">
  <tr>
    <td style="width: 80%; vertical-align: top;">
<p class="detailed-text"> 
Still deeply interested by improving our knowledge about multiple stressors' effects on fish health to improve conservation practices, I will join the <a href='https://eng-eabx.bordeaux-aquitaine.hub.inrae.fr/'>Aquatic ecosystems and global change research unit (EABX)</a> in February 2024.<br/><br/>
More particularly, I will become a member of the <a href='https://scholar.google.fr/citations?hl=fr&user=2KksVvoAAAAJ&view_op=list_works&sortby=pubdate'>Bertrand VILLENEUVE</a>'s lab to investigate how anthropogenic pressures such as pollution, temperature, hydromophology, dams, and so on may contribute to the decline of migratory fish species (e.g., <em>Alosa alosa</em>, <em>Salmo salar</em>, <em>Anguilla anguilla</em>) along river continuum.<br/><br/>
More details to come soon ! 
</p>
</td>
    <td style="width: 20%; vertical-align: top;">
    
```{r EABXLogoSet, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("inrae", "ofb")
for(i in tofind){ 
...
<p class="plain-text">
`r fontawesome::fa("briefcase", fill = "#333333")` &ensp; March 2021 - October 2022 | Postdoctoral researcher | <a href='https://www6.paca.inrae.fr/institut-sophia-agrobiotech'>National Research Institute for Agriculture, Food and Environment—INRAE</a>, Sophia-Antipolis, FR </p>
<p class="detailed-text">
...
<u>Supervisor(s):</u> Dr. Vincent CALCAGNO.</em><br/></p>
<details>
  <summary class= "summary">
  Read the story behind (click to unroll)
  </summary>
...
This work also inspired the development of the MoveR `r fontawesome::fa("r-project", fill = "steelblue")` package, intending to easily import, visualize,  process, filter, and analyze movement data obtained from video-tracking softwares.<br/><br/>
See here for:<br/>
&#8226; <a href="https://qpetitjean.github.io/MoveR/index.html">Package documentation</a> <br/>
&#8226; <a href="https://www.biorxiv.org/content/10.1101/2023.11.08.566216v1">Preprint hosted in bioRxiv</a> <br/>
&#8226; <a href="https://www.softxjournal.com/article/S2352-7110(24)00045-1/fulltext">Edited article published in SoftwareX</a>.</p>
</td>
    <td style="width: 20%; vertical-align: top;">
    
```{r ISALogoSet, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("bidime", "inrae", "anr", "ecophyto", "isa", "gredeg", "cbgp", "astredhor", "chambrAgrPaca", "bioline")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
width <- logoData$widthpx[logoData$Logo == i]
...
<div class="video-container">
  <iframe width="100%" height="100%"
          src="https://www.youtube.com/embed/Y9ltf08Iqb4"
          title="Video-phenotyping of thermal performances in minute wasps"
          loading="lazy"
...
<p class="plain-text">
`r fontawesome::fa("briefcase", fill = "#333333")` &ensp; January 2020 - December 2021 and March 2023 - January 2024| Postdoctoral researcher | <a href='https://www.inp-toulouse.fr/fr/index.html'>National Polytechnic Institute—INP</a>, Toulouse, FR </p>
<p class="detailed-text">
...
<u>Supervisor(s):</u> Dr. Lisa JACQUIN, Dr. Jo&euml;l WHITE & Pr. Pascal LAFFAILLE.</em><br/></p>
<details>
  <summary class= "summary">
  Read the story behind (click to unroll)
  </summary>
...
While the COVID-19 pandemic knocked at the world's door, we were coerced to delay laboratory analyses (DNA extractions – PCR – NGS). Fortunately, I just had enough time to finish lab' and bioinformatic analyses before leaving this position for the next one. <br/><br/>
Finally, I just get back to the datasets analyses and writing during a new postdoctoral contract this year (2023) <br/><br/>
In March 2025, we finally published a preprint reporting the first results of this line of work: “Experimental metal contamination reduces gut microbiota diversity and alters its composition and function in wild-caught fish.” Here we found that metal contamination consistently reduced both taxonomic and predicted functional diversity of the gut microbiota, decreasing biosynthesis (e.g., cell-structure and amino-acid precursors) while increasing energy-production pathways (e.g., anaerobic respiration). Surprisingly, we detected no interaction between metals and the immune challenge, and no difference among populations despite their contrasting exposure histories, pointing to a strong, generalizable microbiome response to metal stress.
<br/><br/>
See here for:<br/>
&#8226; <a href="https://www.biorxiv.org/content/10.1101/2025.03.21.644596v1">Preprint hosted in bioRxiv</a> <br/></p>

</p>
</td>
    <td style="width: 20%; vertical-align: top;">
    
```{r crbeLogoSet1, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("crbe", "ensat", "TlseUniv", "cnrs", "genotoul")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
width <- logoData$widthpx[logoData$Logo == i]
...
<u>Supervisor(s):</u> Dr. Lisa JACQUIN, Dr. S&eacute;verine JEAN & Pr. Pascal LAFFAILLE.</em><br/></p>
<details>
  <summary class= "summary">
  Read the story behind (click to unroll)
  </summary>
...
```{r PhDVensDiag, echo=FALSE, results='asis', message=FALSE, warning=FALSE, fig.align = 'center', out.width="65%", fig.cap="Summary of the research questions investigated during during my Ph.D. and the complementary approaches used to tackle them.", fig.alt="Diagram summarizing field that QUentin Petitjean'PhD works encompass."}
...
```{r CRBELogoSet2, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("crbe", "ensat", "TlseUniv", "cnrs", "AEAG", "ec2co", "MESRI")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
width <- logoData$widthpx[logoData$Logo == i]
...
<u>Supervisor(s):</u> Dr. Annette DE VAUFLEURY & Dr. Fr&eacute;d&eacute;ric GIMBERT.</em><br/></p>
<details>
  <summary class= "summary">
  Read the story behind (click to unroll)
  </summary>
...
```{r GraphAbsChemos, echo=FALSE, results='asis', message=FALSE, warning=FALSE, fig.align = 'center', out.width="90%", fig.cap="Summary of the results discussed in <a href='https://qpetitjean.github.io/qpetitjean_distill/publications.html#section'>Petitjean et al., 2021 Origin, fate and ecotoxicity of manganese from legacy metallurgical wastes</a>.", fig.alt="Summary of the results discussed in Petitjean et al., 2021."}
...
```{r ChronoEnvLogoSet1, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("chronoEnv", "FCUniv", "UBFC", "cnrs", "BFC", "DRAAC", "PEA2T", "femto")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
width <- logoData$widthpx[logoData$Logo == i]
...
<u>Supervisor(s):</u> Dr. Fr&eacute;d&eacute;ric GIMBERT & Pr. Aleya LOTFI.</em><br/></p>
<details>
  <summary class= "summary">
  Read the story behind (click to unroll)
  </summary>
...
```{r CagesTypes, echo=FALSE, results='asis', message=FALSE, warning=FALSE, fig.align = 'center', out.width="80%", fig.cap="Type of cages used for active biomonitoring, the cage on the left (WS) allows exposing the midges to water and sediment. In contrast, the cage on the right (W) allows exposing the midges to water only.", fig.alt="Shema of the cages used in Gimbert et al., 2018."}
...
```{r ChronoEnvLogoSet2, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("chronoEnv", "FCUniv", "UBFC", "cnrs", "BFC")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
width <- logoData$widthpx[logoData$Logo == i]
...
```{r Sub1, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("setac", "syngenta")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
width <- logoData$widthpx[logoData$Logo == i]
height <- logoData$heightpx[logoData$Logo == i]

Res[i] <- sprintf('<div style="display: inline-block; margin-right: 10px;">
<a title="%s" href="%s">
<img src="%s" width="%spx" height="%spx" />
</a></div>', Website, Website, Logo, width, height)

}
cat('<div style="text-align: center;">', Res, '</div>', sep = "")
```
  <p class="detailed-text">
...
```{r Sub2, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("MESRI", "TlseUniv", "sdu2e")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
width <- logoData$widthpx[logoData$Logo == i]
...
```{r Sub3, echo = FALSE, results='asis'}
logoData <- read.csv2("Other/LogoURL.csv")
Res <- c()
tofind <- c("GalwayUniv", "europeFlag")
for(i in tofind){ 
Logo <- logoData$URL[logoData$Logo == i]
Website <- logoData$website[logoData$Logo == i]
height <- logoData$heightpx[logoData$Logo == i]
...
Res[i] <- sprintf('<div style="display: inline-block; margin-right: 10px;">
<a title="%s" href="%s">
<img src="%s" height="%spx" />
</a></div>', Website, Website, Logo, height)
...
### MEMBERSHIP 
<p class="plain-text" style="text-align: left">
`r fontawesome::fa("handshake", fill = "#333333")` &ensp; ECOTOX INRAE network animation team&nbsp;<a href='https://eng-ecotox.hub.inrae.fr/'>(ECOTOX)</a> <br/>
`r fontawesome::fa("handshake", fill = "#333333")` &ensp; Co-coordinator of the Young Ecotoxicologists Group of the ECOTOX INRAE network&nbsp;<a href='https://ecotox.hub.inrae.fr/actualites/yeg-ecotox'>(YEG)</a> <br/>
`r fontawesome::fa("handshake", fill = "#333333")` &ensp; Co-coordinator of the Pesticides & Pollinators Group of the POLLINECO network&nbsp;<a href='https://pollineco.org/'>(POLLINECO)</a> <br/>
...
`r fontawesome::fa("handshake", fill = "#333333")` &ensp; French Reproducible Research Network&nbsp;<a href='https://www.recherche-reproductible.fr/'>(FR-RR)</a> <br/>
...
# Load data
filePath <- "C:/Users/qpetitjean/Desktop/WORK/Reviews/Recap_reviews-QP.xlsx"
ArticleRevData <- readxl::read_excel(filePath, sheet = "ArticleRevSummary")
DataRevData <- readxl::read_excel(filePath, sheet = "DataRevSummary")
URL <- readxl::read_excel(filePath, sheet = "JournalsURL")

```

```{r PeerRevSum, echo=FALSE}
# Aggregate the total number of reviews per journal for Article reviews
ArticleReviewsPerJournal <-
  with(
    ArticleRevData[!is.na(ArticleRevData$`Date review Submitted`), ],
    aggregate(
      `Date review Submitted`,
      by = list(JournalName = `Journal name`),
      FUN = length
    )
  )
colnames(ArticleReviewsPerJournal)[2] <- "TotalArticleReviews"

# Aggregate the total number of reviews per journal for Data reviews
DataReviewsPerJournal <-
  with(DataRevData[!is.na(DataRevData$`Date review Submitted`),],
       aggregate(
         `Date review Submitted`,
         by = list(JournalName = `Journal name`),
         FUN = length
       ))
colnames(DataReviewsPerJournal)[2] <- "TotalDataReviews"

# Merge the two dataframes by JournalName
totalReviewsPerJournal <- merge(ArticleReviewsPerJournal, DataReviewsPerJournal, by = "JournalName", all = TRUE)

# Replace NA with 0 for journals that have reviews in only one of the datasets
totalReviewsPerJournal$TotalArticleReviews[is.na(totalReviewsPerJournal$TotalArticleReviews)] <- 0
totalReviewsPerJournal$TotalDataReviews[is.na(totalReviewsPerJournal$TotalDataReviews)] <- 0

# Calculate the total number of reviews for each journal
totalReviewsPerJournal$TotalReviews <- totalReviewsPerJournal$TotalArticleReviews + totalReviewsPerJournal$TotalDataReviews

# Sort the dataframe by the total number of reviews in descending order
totalReviewsPerJournal <- totalReviewsPerJournal[order(-totalReviewsPerJournal$TotalReviews), ]

```

```{r PeerRevHTML, echo=FALSE,  results='asis'}
# Create the HTML string indicating the number of review performed for each journal
htmlOutput <- c()
for (i in 1:nrow(totalReviewsPerJournal)) {
  journalName <- totalReviewsPerJournal$JournalName[i]
  reviewCount <- totalReviewsPerJournal$TotalReviews[i]
  journalURL <- URL[grep(journalName, URL$JournalName), "URL"]
  
  htmlString <- paste0(
    '<p class="plain-text" style="text-align: left; margin: 0; ">',
    fontawesome::fa("file-lines", fill = "#333333"), '&ensp; ',
    '<a href="', journalURL, '">', journalName, '</a>&nbsp;(n=', reviewCount, ')<br/>',
    '</p>'
  )
  htmlOutput <- c(htmlOutput, htmlString)
}  
  
cat(paste(htmlOutput, collapse = "\n"))

```

### EDITORIAL DUTIES
`r fontawesome::fa("file-lines", fill = "#333333")` &ensp; Data editor at&nbsp;<a href='https://onlinelibrary.wiley.com/journal/14610248'>Ecology Letters (since June 2023)</a> <br/>
`r fontawesome::fa("file-lines", fill = "#333333")` &ensp; Review editor at&nbsp;<a href='https://www.frontiersin.org/'>Frontiers in Fish Science (since Aug. 2023)</a> <br/>

### REVIEW SUMMARY
```{r PrepDataPlot, echo=FALSE}
# Extract years from Date review Submitted
ArticleRevData$Year <- format(ArticleRevData$`Date review Submitted`, "%Y")
DataRevData$Year <- format(DataRevData$`Date review Submitted`, "%Y")

# Aggregate the number of reviews per year for each type
ArticleReviewsPerYear <- aggregate(ArticleRevData$`Date review Submitted`, by = list(Year = ArticleRevData$Year), FUN = length)
names(ArticleReviewsPerYear)[2] <- "ArticleReviews"

DataReviewsPerYear <- aggregate(DataRevData$`Date review Submitted`, by = list(Year = DataRevData$Year), FUN = length)
names(DataReviewsPerYear)[2] <- "DataReviews"

# Merge the data frames by Year and calculate the sum of reviews
reviewsPerYear <- merge(ArticleReviewsPerYear, DataReviewsPerYear, by = "Year", all = TRUE)
reviewsPerYear$ArticleReviews[is.na(reviewsPerYear$ArticleReviews)] <- 0
reviewsPerYear$DataReviews[is.na(reviewsPerYear$DataReviews)] <- 0
reviewsPerYear$TotalReviews <- reviewsPerYear$ArticleReviews + reviewsPerYear$DataReviews

```

```{r PlotData, echo=FALSE, fig.align = 'left', out.width="80%", fig.height = 4, dpi = 300, dev = "png", dev.args=list(bg="transparent"), fig.cap="Summary of Article and Data & Code Reviews Performed over the Years"}
# Display the plot
ggplot2::ggplot(reviewsPerYear, ggplot2::aes(x = as.numeric(Year))) +
  ggplot2::geom_line(ggplot2::aes(y = ArticleReviews, color = "Article Reviews"),
                     linewidth = 1.2) +
  ggplot2::geom_line(ggplot2::aes(y = DataReviews, color = "Data & Code Reviews"), linewidth = 1.2) +
  ggplot2::geom_line(ggplot2::aes(y = TotalReviews, color = "Total Reviews"), linewidth = 1.2) +
  ggplot2::geom_point(ggplot2::aes(y = ArticleReviews, color = "Article Reviews"),
                      size = 6) +
  ggplot2::geom_point(ggplot2::aes(y = DataReviews, color = "Data & Code Reviews"), size = 6) +
  ggplot2::geom_point(ggplot2::aes(y = TotalReviews, color = "Total Reviews"), size = 6) +
  ggplot2::geom_text(
    ggplot2::aes(y = ArticleReviews, label = ArticleReviews, color = "Article Reviews"),
    vjust = 0.5,
    hjust = 0.5,
    color = "white",
    size = 3.5,
  ...
  ggplot2::geom_text(
    ggplot2::aes(y = DataReviews, label = DataReviews, color = "Data & Code Reviews"),
    vjust = 0.5,
    hjust = 0.5,
    color = "white",
    size = 3.5,
  ...
  ggplot2::geom_text(
    ggplot2::aes(y = TotalReviews, label = TotalReviews, color = "Total Reviews"),
    vjust = 0.5,
    hjust = 0.5,
    color = "white",
    size = 3.5,
  ...
  ggplot2::ggtitle("") +
  ggplot2::scale_x_continuous(breaks = unique(as.numeric(reviewsPerYear$Year))) +
  ggplot2::labs(y = "# of Reviews", color = "Review Type") +
  ggplot2::scale_color_manual(
    values = c(
      "Article Reviews" = "#18BC9C",
      # rgba(24, 188, 156, 1)
      "Data & Code Reviews" = "#7570B3",
      # rgba(117, 112, 179, 1)
      "Total Reviews" = "#14827D"     
      # rgba(20, 130, 125, 1)
    )
  ) +
  ...
  ggplot2::scale_y_continuous(limits = c(
    0,
    max(reviewsPerYear$ArticleReviews, reviewsPerYear$TotalReviews) + 1
  ),
  breaks = seq(
    0,
    max(reviewsPerYear$ArticleReviews, reviewsPerYear$TotalReviews) + 1,
...
`r fontawesome::fa("person-hiking", fill = "#333333")` &ensp; Sports: Basket ball, running <br/>
