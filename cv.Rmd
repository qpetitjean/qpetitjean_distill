...
<br/>
<p style='font-family: var(--font-header); font-weight: 700; color: var(--header-color); font-style: bold; font-size:200%;'>Quentin PETITJEAN, Ph.D&nbsp;<a href="mailto:q.petitjean1@gmail.com"><i class="fa fa-envelope fa-1.5x" aria-hidden="true"></i></a></p>
...
Here I mainly collaborated with <a href='https://fr.linkedin.com/in/michela-ion-scotta'>Michela ION SCOTTA</a> who reared the populations of small parasitoid fly named <em>Trichogramma</em>. Michela has also video-recorded the insect groups during steady decreases/increases in temperature (2 hours, see fig. 1).</p>
...
<table style="border: none; width='100%';">
  <tr>
    <td style="width: 80%; vertical-align: top;">
<p class="detailed-text">
During my first year of master I conducted an internship with <a href='https://chrono-environnement.univ-fcomte.fr/spip.php?page=perso&nom=GIMBERT&prenom=Fr%C3%A9d%C3%A9ric'> Frédéric GIMBERT</a> and <a href='https://chrono-environnement.univ-fcomte.fr/spip.php?page=perso&nom=ALEYA&prenom=Lotfi'>Lotfi ALEYA</a>  to work on the bioavailability of trace metal elements in a landfill leachate collection pond. Indeed, until 2002 household waste disposal was authorized in France, resulting in contamination of the surrounding environment, primarily through contaminants leaching. To reduce environmental contamination entailed by this mode of waste storage, the Etueffont landfill (study site) set up a lagoon ponds system draining landfill leachates.<br/>
Here, we aimed to better understand how the leaching of trace metal elements may affect contaminant accumulation in biota (i.e., bioaccumulation kinetics) and how water and sediment compartments may contribute to the observed bioaccumulation' patterns.<br/>
To tackle these aims, we used an active biomonitoring approach through caging laboratory-raised midges larvae (<em>Chironomus riparius</em>) in the first landfill leachate collection pond. More particularly, we used two types of cages to either expose the larvae to water only or water and sediment for a five days maximum duration (see fig. 2).<br/>
```{r CagesTypes, echo=FALSE, results='asis', message=FALSE, warning=FALSE, fig.align = 'center', out.width="80%", fig.cap="Type of cages used for active biomonitoring, the cage on the left allows exposing the midges to water and sediment. In contrast, the cage on the right allows exposing the midges only to water."}
...
For more information, see the <a href='https://qpetitjean.github.io/qpetitjean_distill/publications.html#section-3'>Publication section</a> of this website.</p>
    ...
    <td style="width: 20%; vertical-align: top;">
    <a href='https://chrono-environnement.univ-fcomte.fr/'><img src="https://chrono-environnement.univ-fcomte.fr/IMG/siteon0.png?1512470683" height="50px" width="155px" /></a></br>
    <a href='https://www.univ-fcomte.fr/'><img src="https://www.univ-fcomte.fr/sites/all/themes/ufc_central/logo.png" height="43px" width="155px" /></a></br>
