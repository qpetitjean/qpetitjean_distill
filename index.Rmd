...
links:
  - label: '`r fontawesome::fa("envelope", fill = "#333333")`'
    url: "mailto:q.petitjean1@gmail.com"
  - label: '`r fontawesome::fa("github", fill = "#333333")`'
    url: "https://github.com/qpetitjean"
  - label: '`r fontawesome::fa("twitter", fill = "#333333")`'
    url: "https://twitter.com/Q_PETITJEAN"
  - label: '`r fontawesome::fa("orcid", fill = "#333333")`'
...
```{r metadata, include=FALSE, results='asis'}
  metathis::meta_social(
    ...
    url = "https://qpetitjean.github.io/",
    image = "images/Home_QP.png",
...
`r fontawesome::fa("square-caret-right", fill = "#333333")` &ensp; Create package -- see the MoveR package (Stay tuned for upcoming release. <br/>
