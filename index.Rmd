...
htmlImageTag <- paste0('<img src="', imgPreview, '" style="height: 80px; margin-left: 10px; vertical-align: middle;">')
...
htmlDisplay <- paste0(
  ...
  '<h2 style="margin: 0; font-family: \'Edu QLD Beginner\', cursive, Arial, sans-serif;">', newsTitle, '</h2>',
  '</a>',
  '</div>',
  htmlImageTag,
  '</div>'
